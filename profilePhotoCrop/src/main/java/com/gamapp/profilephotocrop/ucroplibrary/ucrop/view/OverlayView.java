...
import com.gamapp.profilephotocrop.ucroplibrary.ucrop.callback.OverlayViewChangeListener;
...
//        }
    ...
    protected void drawCropGrid(@NonNull Canvas canvas) {
        ...
        if (mShowCropFrame) {
            if (mCircleDimmedLayer)
                canvas.drawCircle(mCropViewRect.centerX(), mCropViewRect.centerY(), Math.min(mCropViewRect.width(), mCropViewRect.height()) / 2f, mCropFramePaint);
            else
