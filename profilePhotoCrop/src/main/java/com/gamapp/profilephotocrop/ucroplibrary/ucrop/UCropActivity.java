package com.gamapp.profilephotocrop.ucroplibrary.ucrop;
...
import com.gamapp.profilephotocrop.R;
import com.gamapp.profilephotocrop.ucroplibrary.ucrop.callback.BitmapCropCallback;
import com.gamapp.profilephotocrop.ucroplibrary.ucrop.model.AspectRatio;
import com.gamapp.profilephotocrop.ucroplibrary.ucrop.util.SelectedStateListDrawable;
import com.gamapp.profilephotocrop.ucroplibrary.ucrop.view.CropImageView;
import com.gamapp.profilephotocrop.ucroplibrary.ucrop.view.GestureCropImageView;
import com.gamapp.profilephotocrop.ucroplibrary.ucrop.view.OverlayView;
import com.gamapp.profilephotocrop.ucroplibrary.ucrop.view.TransformImageView;
import com.gamapp.profilephotocrop.ucroplibrary.ucrop.view.UCropView;
import com.gamapp.profilephotocrop.ucroplibrary.ucrop.view.widget.AspectRatioTextView;
import com.gamapp.profilephotocrop.ucroplibrary.ucrop.view.widget.HorizontalProgressWheelView;
...
public class UCropActivity extends AppCompatActivity {
    ...
    private static final long CONTROLS_ANIMATION_DURATION = 200;
    ...
    private ViewGroup mWrapperStateAspectRatio, mWrapperStateRotate, mWrapperStateScale, mWrapperStateScaleRotate;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setInitialState();
        addBlockingView();
        exploreView((ViewGroup) this.findViewById(android.R.id.content).getRootView(), new OnViewCaptured() {
            @Override
            public void onFind(View view) {
                if (view instanceof TextView) {
                    if (UCrop.typeface != null)
                        ((TextView) view).setTypeface(UCrop.typeface);
                }
            }
        });
    }

    interface OnViewCaptured {
        void onFind(View view);
    }

    private void exploreView(ViewGroup viewGroup, OnViewCaptured onViewCaptured) {
        for (int i = 0; i < viewGroup.getChildCount(); i++) {
            View view = viewGroup.getChildAt(i);
            if (view instanceof ViewGroup) {
                exploreView((ViewGroup) view, onViewCaptured);
            } else {
                onViewCaptured.onFind(view);
            }
        }
    }
...
//            return true;
    ...
    private void setupViews(@NonNull Intent intent) {
        ...
        if (mShowBottomControls) {
            ...
            mWrapperStateScaleRotate = findViewById(R.id.state_scale_rotate);
            mWrapperStateScaleRotate.setOnClickListener(mStateClickListener);
...
//        toolbar.setNavigationIcon(stateButtonDrawable);
    ...
    private void initiateRootViews() {
        ...
        cropButton.setOnClickListener(v -> cropAndSaveImage());
    ...
    private void setWidgetState(@IdRes int stateViewId) {
        ...
        mWrapperStateScaleRotate.setSelected(stateViewId == R.id.state_scale_rotate);


        (findViewById(R.id.wrapper_controls)).setVisibility(stateViewId == R.id.state_scale_rotate ? View.GONE : View.VISIBLE);
        ...
        } else if (stateViewId == R.id.state_scale_rotate) {
    ...
    private void changeSelectedTab(int stateViewId) {
        ...
        mWrapperStateScaleRotate.findViewById(R.id.text_view_scale_rotate).setVisibility(stateViewId == R.id.state_scale_rotate ? View.VISIBLE : View.GONE);
    ...
    protected void cropAndSaveImage() {
        ...
        mGestureCropImageView.cropAndSaveImage(mCompressFormat, mCompressQuality, new BitmapCropCallback() {
            @Override
            public void onBitmapCropped(@NonNull Uri resultUri, Bitmap mResultBitmap, int offsetX, int offsetY, int imageWidth, int imageHeight) {
                setResultUri(resultUri, mResultBitmap, mGestureCropImageView.getTargetAspectRatio(), offsetX, offsetY, imageWidth, imageHeight);
                finish();
            }
    ...
    protected void setResultUri(Uri uri, Bitmap mResultBitmap, float resultAspectRatio, int offsetX, int offsetY, int imageWidth, int imageHeight) {
